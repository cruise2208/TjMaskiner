( function( $ ) {
	...
	$(function() {
		var embeddedSetting = $('#woocommerce_quickpay_quickpay_embedded_payments_enabled');
		var generalEmbeddedSettingRows = $('#woocommerce_quickpay_quickpay_embedded_autojump').closest('tr');
