...
(function ($) {
    var WCQP_Checkout = function (_OverlayBase) {
        ...
        function WCQP_Checkout(form) {
            ...
            var _this = _possibleConstructorReturn(this, (WCQP_Checkout.__proto__ || Object.getPrototypeOf(WCQP_Checkout)).call(this, form));
        ...
        _createClass(WCQP_Checkout, [{
            ...
            value: function _setupQuickPay() {
                ...
                QuickPay.Embedded.Form(document.querySelector('#wcqp-payment-form'), {
                    merchant_id: wcqp.settings.merchant_id,
                    agreement_id: wcqp.settings.agreement_id,
                    brandChanged: function brandChanged(brand) {
                        _this2.brands.children().removeClass('is-active');
                        _this2.brands.children('.wcqp-card-brand__' + brand).addClass('is-active');
                    },
                    beforeCreate: function beforeCreate(form) {
                        if (_this2.isLoading) {
                            return false;
