...
var $ = jQuery;
var QuickPay = window.QuickPay || {};
var wcqp = window.wcqp || {};
...
var OverlayBase = function () {
    ...
    function OverlayBase(form) {
        ...
        this.modal = $('#wcqp-payment-modal');

        this.amount = this.modal.find('.wcqp-modal-header__amount').first();

        this.dialog = this.modal.find('.wcqp-modal__dialog').first();

        this.brands = this.modal.find('.wcqp-card-brand');

        this.inner = this.modal.find('#wcqp-payment-form__inner').first();

        this._setupForm();
        this._setupQuickPay();

        this.styles = {
            modal: 'wcqp-modal--visible wcqp-animated fadeIn',
            dialog: 'wcqp-animated bounceIn',
            pageWrapper: 'wcqp-blur'
        };

        this.formInputs = {
            cardNumberInput: this.modal.find('[data-quickpay="cardnumber"]'),
            expiryInput: this.modal.find('[data-quickpay="expiration"]'),
            cvcInput: this.modal.find('[data-quickpay="cvd"]')
        };
        ...
        $('body').on('wcqp-overlay--amount-changed', this._onAmountUpdated);
    }

    /**
     * Listen on keyup as the QuickPay embed form validator does not validate the fields if listening to input
     */
    ...
    _createClass(OverlayBase, [{
        ...
        value: function setupAutojump() {
            var self = this;
            this.formInputs.cardNumberInput.on('keyup.wcqp', function () {
                self.resetValidationErrors();
                if (_payform2.default.validateCardNumber(this.value)) {
                    self.jumpToNextField(this);
                }
            });
            this.formInputs.cvcInput.on('keyup.wcqp', function () {
                self.resetValidationErrors();
                if (_payform2.default.validateCardCVC(this.value)) {
                    self.jumpToNextField(this);
                }
            });
            this.formInputs.expiryInput.on('keyup.wcqp', function () {
        ...
        /**
         * Checks if the payment gateway selected is quickpay.
         *
         * @returns {boolean}
         * @private
         */
        ...
        key: '_isQuickPayGatewaySelected',
        value: function _isQuickPayGatewaySelected() {
            return $('[name="payment_method"]:checked').val() === 'quickpay';
        }
        ...
        value: function closeModal() {
            ...
            var redirect = this.modal.find('.wcqp-modal-header__close').data('close-redirect');
        ...
        value: function _eventSubmit(e) {
            if (this._isQuickPayGatewaySelected()) {
        ...
        value: function _setValidationErrors(fields) {
            ...
            $.each(fields, function (index, field) {
                _this2.modal.find('[data-quickpay="' + field + '"]').closest('.form-row').addClass('woocommerce-invalid');
            });
        }
        ...
        value: function _setupForm() {
            ...
            this.tokenField = $('<input type="hidden" name="quickpay_token" />');
            this.form.on('click', '#place_order', this._eventSubmit.bind(this));
            this.modal.on('click', '.wcqp-modal-header__close', function () {
        ...
        value: function _setCompletedState() {
            this.modal.find('.wcqp-modal-header').hide();
            this.modal.find('#wcqp-payment-form').hide();
            this.modal.find('.wcqp-modal-completed').fadeIn();
        }
    }, {
        key: '_resetCompletedState',
        value: function _resetCompletedState() {
            this.modal.find('.wcqp-modal-header').show();
            this.modal.find('#wcqp-payment-form').show();
            this.modal.find('.wcqp-modal-completed').hide();
        }
        ...
        value: function _showErrors(errors) {
            ...
            this.inner.find('.wcqp-modal-errors').remove();

            var errorContainer = $('<div class="wcqp-modal-errors"></div>').hide();

            $.each(errors, function (index, error) {
                return errorContainer.append($('<div class="wcqp-modal-errors__error"></div>').html(error));
            });
        ...
        /**
         * Applies QuickPay embedded payment logic
         * @private
         */

    }, {
        key: '_setupQuickPay',
        value: function _setupQuickPay() {
            var _this4 = this;

            QuickPay.Embedded.Form(document.querySelector('#wcqp-payment-form'), {
                payment_link: this.modal.data('link'),
                brandChanged: function brandChanged(brand) {
                    _this4.brands.children().removeClass('is-active');
                    _this4.brands.children('.wcqp-card-brand__' + brand).addClass('is-active');
                },
 ...
 */
(function ($) {
    var WCQP_Checkout = function (_OverlayBase) {
        _inherits(WCQP_Checkout, _OverlayBase);

        function WCQP_Checkout(form) {
            _classCallCheck(this, WCQP_Checkout);

            return _possibleConstructorReturn(this, (WCQP_Checkout.__proto__ || Object.getPrototypeOf(WCQP_Checkout)).call(this, form));
        }

        return WCQP_Checkout;
    }(_overlayBase2.default);

    new WCQP_Checkout($("form.checkout, form#order_review, form#add_payment_method"));
})(jQuery);
...
// module
exports.push([module.i, ".wcqp-animated {\n  visibility: visible !important; }\n\n/*!\nAnimate.css - http://daneden.me/animate\nLicensed under the MIT license - http://opensource.org/licenses/MIT\nCopyright (c) 2015 Daniel Eden\n*/\nbody {\n  -webkit-backface-visibility: hidden; }\n\n.animated, .wcqp-animated {\n  -webkit-animation-duration: 1s;\n  animation-duration: 1s;\n  -webkit-animation-fill-mode: both;\n  animation-fill-mode: both; }\n  .animated.infinite, .infinite.wcqp-animated {\n    animation-iteration-count: infinite; }\n  .animated.hinge, .hinge.wcqp-animated {\n    -webkit-animation-duration: 2s;\n    animation-duration: 2s; }\n  .animated.bounceIn, .bounceIn.wcqp-animated, .animated.bounceOut, .bounceOut.wcqp-animated {\n    -webkit-animation-duration: 0.75s;\n    animation-duration: 0.75s; }\n  .animated.flipOutX, .flipOutX.wcqp-animated, .animated.flipOutY, .flipOutY.wcqp-animated {\n    -webkit-animation-duration: 0.75s;\n    animation-duration: 0.75s; }\n\n@-webkit-keyframes shake {\n  0%, 100% {\n    -webkit-transform: translateX(0); }\n  10%, 30%, 50%, 70%, 90% {\n    -webkit-transform: translateX(-10px); }\n  20%, 40%, 60%, 80% {\n    -webkit-transform: translateX(10px); } }\n\n@keyframes shake {\n  0%, 100% {\n    transform: translateX(0); }\n  10%, 30%, 50%, 70%, 90% {\n    transform: translateX(-10px); }\n  20%, 40%, 60%, 80% {\n    transform: translateX(10px); } }\n\n.shake {\n  -webkit-animation-name: shake;\n  animation-name: shake; }\n\n@-webkit-keyframes bounceIn {\n  0% {\n    opacity: 0;\n    -webkit-transform: scale(0.3); }\n  50% {\n    opacity: 1;\n    -webkit-transform: scale(1.05); }\n  70% {\n    -webkit-transform: scale(0.9); }\n  100% {\n    -webkit-transform: scale(1); } }\n\n@keyframes bounceIn {\n  0% {\n    opacity: 0;\n    transform: scale(0.3); }\n  50% {\n    opacity: 1;\n    transform: scale(1.05); }\n  70% {\n    transform: scale(0.9); }\n  100% {\n    transform: scale(1); } }\n\n.bounceIn {\n  -webkit-animation-name: bounceIn;\n  animation-name: bounceIn; }\n\n@-webkit-keyframes fadeIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n.fadeIn {\n  -webkit-animation-name: fadeIn;\n  animation-name: fadeIn; }\n\n@-webkit-keyframes fadeOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n@keyframes fadeOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n.fadeOut {\n  -webkit-animation-name: fadeOut;\n  animation-name: fadeOut; }\n\n@keyframes scaleAnimation {\n  0% {\n    opacity: 0;\n    transform: scale(1.5); }\n  100% {\n    opacity: 1;\n    transform: scale(1); } }\n\n@keyframes drawCircle {\n  0% {\n    stroke-dashoffset: 151px; }\n  100% {\n    stroke-dashoffset: 0; } }\n\n@keyframes drawCheck {\n  0% {\n    stroke-dashoffset: 36px; }\n  100% {\n    stroke-dashoffset: 0; } }\n\n@keyframes fadeOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n.wcqp-modal-completed__icon__circle {\n  stroke-dasharray: 151px 151px;\n  stroke: #FFF; }\n\n.wcqp-modal-completed__icon__check {\n  stroke-dasharray: 36px 36px;\n  stroke: #FFF; }\n\n.wcqp-modal-completed__icon__result {\n  fill: #FFF;\n  opacity: 0; }\n\n.wcqp-modal-completed__icon.wcqp-animated {\n  animation: 1s ease-out 0s 1 both scaleAnimation; }\n  .wcqp-modal-completed__icon.wcqp-animated .wcqp-modal-completed__icon__circle {\n    animation: 1s cubic-bezier(0.77, 0, 0.175, 1) 0s 1 both drawCircle, 0.3s linear 0.9s 1 both fadeOut; }\n  .wcqp-modal-completed__icon.wcqp-animated .wcqp-modal-completed__icon__check {\n    animation: 1s cubic-bezier(0.77, 0, 0.175, 1) 0s 1 both drawCheck, 0.3s linear 0.9s 1 both fadeOut; }\n  .wcqp-modal-completed__icon.wcqp-animated .wcqp-modal-completed__icon__result {\n    animation: 0.3s linear 0.9s both fadeIn; }\n\n.wcqp-modal-errors {\n  background: #bf2401;\n  padding: 7px 10px !important; }\n  .wcqp-modal-errors__error {\n    color: #FFFFFF !important;\n    font-size: 12px !important; }\n    .wcqp-modal-errors__error:not(:last-child) {\n      margin-bottom: 5px; }\n\n.wcqp-modal {\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: #FFF;\n  background-color: rgba(0, 0, 0, 0.8);\n  position: fixed;\n  z-index: 999999999;\n  visibility: hidden; }\n  .wcqp-modal-title {\n    font-size: 20px;\n    font-weight: bold; }\n  .wcqp-modal__dialog-wrapper {\n    position: fixed;\n    max-width: 430px;\n    width: 100%;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    padding: 0 10px; }\n  .wcqp-modal__dialog {\n    animation-delay: .3s;\n    transform-origin: 50% 50% 0;\n    overflow: hidden;\n    border-radius: 5px;\n    box-shadow: 0px 0px 30px 0px rgba(0, 0, 0, 0.75); }\n  .wcqp-modal iframe {\n    width: 100% !important;\n    border: 0;\n    display: block; }\n    .wcqp-modal iframe div {\n      padding: 10px; }\n\n.wcqp-modal-header {\n  position: relative;\n  text-align: center;\n  display: block;\n  padding: 10px 0;\n  margin: 0;\n  background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%); }\n  .wcqp-modal-header__amount .woocommerce-Price-amount {\n    position: relative;\n    font-size: 50px;\n    font-weight: bold; }\n  .wcqp-modal-header__amount .woocommerce-Price-currencySymbol {\n    font-weight: normal;\n    font-size: .3em;\n    text-shadow: none;\n    align-self: flex-end;\n    margin-bottom: .7em;\n    margin-left: .3em;\n    position: absolute;\n    bottom: 0;\n    transform: translateX(0.2em); }\n  .wcqp-modal-header__amount.is-left .woocommerce-Price-currencySymbol, .wcqp-modal-header__amount.is-left_space .woocommerce-Price-currencySymbol {\n    margin-left: -.3em;\n    transform: translateX(-100%);\n    left: -.1em; }\n  .wcqp-modal-header__close {\n    position: absolute;\n    top: 13px;\n    right: 13px; }\n    .wcqp-modal-header__close svg {\n      width: 10px;\n      height: 10px;\n      opacity: .6;\n      cursor: pointer;\n      transition: all .3s ease-out; }\n      .wcqp-modal-header__close svg:hover {\n        opacity: 1;\n        transform: rotate(90deg); }\n\n.wcqp-modal-disclaimer {\n  margin-top: 12px;\n  color: #FFFFFF;\n  font-size: 10px;\n  text-align: center;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center; }\n  .wcqp-modal-disclaimer img {\n    width: 80px;\n    display: inline-block;\n    position: relative;\n    margin-left: 5px; }\n\n.wcqp-modal-completed {\n  text-align: center;\n  padding: 70px;\n  border: 0 !important;\n  margin: 0 !important; }\n  .wcqp-modal-completed:before, .wcqp-modal-completed:after {\n    display: none !important; }\n\n@keyframes spinAround {\n  from {\n    transform: rotate(0deg); }\n  to {\n    transform: rotate(359deg); } }\n\n#wcqp-loader {\n  display: none; }\n  #wcqp-loader.is-loading {\n    position: relative !important;\n    color: transparent !important;\n    pointer-events: none !important; }\n    #wcqp-loader.is-loading:after {\n      animation: spinAround 500ms infinite linear !important;\n      position: absolute !important;\n      left: calc(50% - (1em / 2)) !important;\n      top: calc(50% - (1em / 2)) !important;\n      position: absolute !important;\n      border: 2px solid #FFFFFF !important;\n      border-radius: 290486px !important;\n      border-right-color: transparent !important;\n      border-top-color: transparent !important;\n      content: \"\" !important;\n      display: block !important;\n      height: 1em !important;\n      width: 1em !important;\n      margin-left: 0 !important; }\n  #wcqp-loader.is-loading {\n    height: 2rem;\n    display: flex; }\n    #wcqp-loader.is-loading:after {\n      border-color: #000 !important;\n      border-right-color: transparent !important; }\n\n#wcqp-payment-form {\n  margin: 0;\n  padding: 0; }\n  iframe + #wcqp-payment-form {\n    display: none; }\n\n#wcqp-payment-form__inner input[data-quickpay=\"cardnumber\"] {\n  width: 100%; }\n\n.wcqp-card-row {\n  border-bottom: 1px solid #eaeaea;\n  padding: 26px 20px 22px;\n  position: relative;\n  background: #FFF;\n  display: flex;\n  align-items: center;\n  flex-direction: row; }\n  @media only screen and (min-width: 768px) {\n    .wcqp-card-row {\n      padding: 17px 25px 24px; } }\n  .wcqp-card-row:after {\n    content: \"\";\n    display: table;\n    clear: both; }\n  .wcqp-card-row + .wcqp-card-row {\n    border-bottom: 0; }\n  .wcqp-card-row .wcqp-card-column {\n    flex: 1; }\n    .wcqp-card-row .wcqp-card-column.is-card {\n      width: 70%; }\n    .wcqp-card-row .wcqp-card-column.is-brand {\n      width: 30%;\n      flex: none; }\n    .wcqp-card-row .wcqp-card-column.is-exp {\n      padding-right: 1rem; }\n    .wcqp-card-row .wcqp-card-column input {\n      width: 100% !important;\n      max-width: 100% !important; }\n    .wcqp-card-row .wcqp-card-column.has-error label {\n      color: #b92909 !important; }\n    .wcqp-card-row .wcqp-card-column .woocommerce-form__label {\n      font-size: 14px; }\n\n.wcqp-flex {\n  display: flex; }\n\n.woocommerce-Button.wcqp-btn--checkout {\n  display: block;\n  width: 100%; }\n  .woocommerce-Button.wcqp-btn--checkout.is-loading {\n    position: relative !important;\n    color: transparent !important;\n    pointer-events: none !important; }\n    .woocommerce-Button.wcqp-btn--checkout.is-loading:after {\n      animation: spinAround 500ms infinite linear !important;\n      position: absolute !important;\n      left: calc(50% - (1em / 2)) !important;\n      top: calc(50% - (1em / 2)) !important;\n      position: absolute !important;\n      border: 2px solid #FFFFFF !important;\n      border-radius: 290486px !important;\n      border-right-color: transparent !important;\n      border-top-color: transparent !important;\n      content: \"\" !important;\n      display: block !important;\n      height: 1em !important;\n      width: 1em !important;\n      margin-left: 0 !important; }\n\n.wcqp-card-brand {\n  text-align: right; }\n  .wcqp-card-brand svg {\n    display: inline-block;\n    opacity: .5;\n    width: 40px;\n    margin-right: 5px;\n    transition: all .2s ease-out; }\n    .wcqp-card-brand svg + svg {\n      margin-right: 0; }\n    .wcqp-card-brand svg.is-active {\n      opacity: 1; }\n  .wcqp-card-brand.visa .wcqp-card-brand__visa {\n    opacity: 1; }\n  .wcqp-card-brand.mastercard .wcqp-card-brand__mastercard {\n    opacity: 1; }\n", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./wcqp-checkout.sass", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./wcqp-checkout.sass");
