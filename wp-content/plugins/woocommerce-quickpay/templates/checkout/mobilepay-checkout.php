...
<div class="mobilepay-checkout">
	...
	<p class="mobilepay-checkout__text"><?php echo apply_filters( 'woocommerce_quickpay_mobilepay_checkout_checkout_text', __( 'Go directly to the MobilePay window with MobilePay Checkout. We will automatically receive your billing- and shipping information from MobilePay.', 'woo-quickpay' ) ) ?></p>
	<p>
